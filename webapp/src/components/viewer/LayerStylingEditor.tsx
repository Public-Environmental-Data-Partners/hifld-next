            ...
            <Select
              ...
              onValueChange={(value) => {
                ...
                const values = mapRef.current
                  ? getSampledValues(
                      mapRef.current,
                      activeLayer.sourceLayerId ?? activeLayer.id,
                      value,
                      5000,
                      activeLayer.mapSourceId,
                    )
                  : [];
            ...
            {activeStyle.colorProperty ? (
              <div className="space-y-2">
                {activeBreaks.length === 0 ? (
                  <div className="text-xs text-muted-foreground">Breakpoints will appear once values are sampled.</div>
                ) : (
