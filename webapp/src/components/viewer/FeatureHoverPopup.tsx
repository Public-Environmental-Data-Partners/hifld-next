...
export function FeatureHoverPopup({
  ...
  return (
    <div
      ref={popupRef}
      className="absolute z-20 flex max-h-[min(16rem,calc(100%-1rem))] w-80 max-w-[calc(100%-1rem)] flex-col overflow-hidden rounded-md border bg-background/95 shadow-md"
      style={{
