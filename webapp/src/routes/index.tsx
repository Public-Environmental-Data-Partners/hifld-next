...
import { discoveryLinkHeaderValue, homePageMarkdown } from "@/lib/agent-discovery";
    ...
    <div>
      ...
      <div className="flex min-h-[calc(100svh-3.5rem)] flex-col items-center justify-center p-4 sm:p-6 lg:p-10">
        <div className="mx-auto w-full max-w-4xl px-1 sm:px-0 text-center">
          <h1 className="text-5xl font-bold tracking-tighter sm:text-7xl lg:text-8xl">HIFLD Next</h1>
          <p className="font-serif mx-auto mt-10 max-w-2xl text-base leading-relaxed text-muted-foreground sm:mt-12 sm:text-lg">
            The Public Environmental Data Partners are committed to preserving and providing public access to federal
            infrastructure and environmental data. When the original HIFLD Open portal went offline, the{" "}
            <a
            ...
            archived the repository. This catalog hosts that preserved collection—400+ datasets available in GeoParquet,
            PMTiles, geodatabase, and other formats—for research, advocacy, policy, and mapping.
          </p>
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 text-center">
          <p className="font-serif mx-auto max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            ...
            <a href="/commons" className="font-medium text-foreground underline underline-offset-2 hover:no-underline">
              HIFLD Next Commons
            </a>
            —a coalition of mission-driven organizations committed to stewarding and expanding the catalog. Stewards:
          </p>
